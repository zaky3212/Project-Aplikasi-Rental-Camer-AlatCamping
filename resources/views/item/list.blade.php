    ...
    <div class="min-h-screen flex flex-col md:flex-row">
        ...
        <aside class="w-full md:w-64 bg-teal-900 text-white flex flex-col shadow-xl">
            ...
            <nav class="flex-1 px-4 py-6 space-y-2 hidden md:block">
                <a href="{{ route('admin.dashboard') }}" class="flex items-center gap-3 px-4 py-3 text-teal-100 hover:bg-teal-800 hover:text-white rounded-lg font-medium transition-colors">
