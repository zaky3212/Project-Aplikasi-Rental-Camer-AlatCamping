                ...
                <div class="bg-white rounded-[1.5rem] md:rounded-[2rem] shadow-sm hover:shadow-xl transition-all duration-500 border border-gray-100 overflow-hidden group relative flex flex-col">
                    ...
                    <div class="aspect-square bg-gray-50 p-4 md:p-6 flex items-center justify-center relative overflow-hidden">
                        ...
                        <img src="https://images.unsplash.com/photo-1523987355523-c7b5b0dd90a7?auto=format&fit=crop&q=80&w=400" 
                             class="max-h-full object-contain transition-transform duration-700 group-hover:scale-110" alt="Alat">
                    </div>

                    <div class="p-4 md:p-6 flex-grow flex flex-col">
                        <p class="text-[8px] md:text-[10px] text-[#f3a933] font-black uppercase tracking-[0.2em] mb-1">Eiger Adventure</p>
                        <h3 class="font-bold text-gray-800 text-sm md:text-base truncate group-hover:text-[#f3a933] transition-colors mb-4 md:mb-5">Tenda Dome Kap. 4</h3>
                        
                        <div class="mt-auto pt-4 border-t border-gray-50">
                            <div class="flex justify-between items-center mb-4">
                                <div class="flex flex-col">
                                    <span class="text-[8px] md:text-[9px] text-gray-400 uppercase font-bold">Sewa</span>
                                    <span class="text-xs md:text-sm font-black text-gray-900">Rp 45k<span class="text-[9px] md:text-[10px] text-gray-400 font-normal">/hari</span></span>
                                </div>
                                <div class="text-right">
                                    <span class="text-[8px] md:text-[9px] text-gray-400 uppercase font-bold block">Stok</span>
                                    <span class="text-[10px] md:text-xs font-bold text-gray-700">8 Pcs</span>
                                </div>
                            </div>
                            
                            <button class="w-full py-2.5 md:py-3 bg-[#0f172a] text-white rounded-lg md:rounded-xl text-[9px] md:text-[10px] font-black uppercase tracking-widest hover:bg-[#f3a933] hover:text-[#0f172a] transition-all duration-300 shadow-md">
