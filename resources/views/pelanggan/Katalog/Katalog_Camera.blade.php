...
<body class="bg-gray-50 font-sans overflow-x-hidden">
  ...
  <nav class="fixed top-0 w-full z-50 bg-[#0f172a]/90 backdrop-blur-lg border-b border-white/10 py-3 md:py-4 px-4 md:px-12 flex justify-between items-center transition-all">
    ...
    <section class="relative h-[350px] md:h-[450px] overflow-hidden">
        ...
        <div class="absolute inset-0 flex items-center px-6 md:px-20">
            <div class="text-white mt-8 md:mt-12 w-full max-w-2xl">
                ...
                <h1 class="text-3xl md:text-6xl lg:text-7xl font-extrabold leading-tight">Perlengkapan<br><span class="text-[#f3a933]">Kamera</span></h1>
                <p class="mt-4 text-gray-300 text-xs md:text-base leading-relaxed line-clamp-3 md:line-clamp-none">Pilih perangkat kamera terbaik untuk menangkap setiap momen berharga Anda. Tersedia berbagai tipe mulai dari DSLR hingga Mirrorless terbaru.</p>
            </div>
        </div>
    </section>
    ...
    <div class="max-w-7xl mx-auto px-4 md:px-6 py-12 md:py-20 space-y-16 md:space-y-24">
        ...
        <section>
            <div class="flex flex-col sm:flex-row justify-between items-start sm:items-end mb-8 md:mb-10 gap-4">
                <div>
                    <h2 class="text-xl md:text-3xl font-bold text-gray-900 flex items-center gap-3 md:gap-4">
                        <span class="p-2 md:p-3 bg-white shadow-sm rounded-xl md:rounded-2xl text-[#f3a933]">
                            <i class="fas {{ $cat['icon'] }}"></i>
                        </span>
                        {{ $cat['name'] }}
                    </h2>
                    <div class="h-1 w-16 md:w-20 bg-[#f3a933] mt-2 md:mt-3 rounded-full"></div>
                </div>
                <button class="text-gray-400 hover:text-[#f3a933] transition-colors flex items-center gap-2 text-[10px] md:text-sm font-bold uppercase tracking-wider">
            ...
            <div class="grid grid-cols-1 xs:grid-cols-2 lg:grid-cols-4 xl:grid-cols-5 gap-4 md:gap-8">
                ...
                <div class="bg-white rounded-[1.5rem] md:rounded-[2rem] shadow-sm hover:shadow-xl transition-all duration-500 border border-gray-100 overflow-hidden group relative flex flex-col">
                    ...
                    <div class="p-4 md:p-6 flex-grow flex flex-col">
                        <p class="text-[8px] md:text-[10px] text-[#f3a933] font-black uppercase tracking-[0.2em] mb-1">Sony Pro Series</p>
                        <h3 class="font-bold text-gray-800 text-sm md:text-base truncate group-hover:text-[#f3a933] transition-colors">Alpha A7 Mark III</h3>
                        
                        <div class="mt-4 md:mt-5 pt-4 md:pt-5 border-t border-gray-50 mt-auto">
                            <div class="flex justify-between items-center mb-4">
                                <div class="flex flex-col">
                                    <span class="text-[8px] md:text-[9px] text-gray-400 uppercase font-bold">Sewa</span>
                                    <span class="text-xs md:text-sm font-black text-gray-900">Rp 25k<span class="text-[9px] md:text-[10px] text-gray-400 font-normal">/Hari</span></span>
                                </div>
                                <div class="text-right">
                                    <span class="text-[8px] md:text-[9px] text-gray-400 uppercase font-bold block">Stok</span>
                                    <span class="text-[10px] md:text-xs font-bold text-gray-700">12 Unit</span>
                                </div>
                            </div>
                            
                            <button class="w-full py-2.5 md:py-3 bg-[#0f172a] text-white rounded-xl text-[8px] md:text-[10px] font-black uppercase tracking-widest hover:bg-[#f3a933] hover:text-[#0f172a] transition-all duration-300 shadow-md">
    ...
    <footer class="bg-[#0f172a] text-white py-12 md:py-16 mt-20">
        <div class="max-w-7xl mx-auto px-6 md:px-8 text-center md:text-left">
            <div class="flex flex-col md:flex-row justify-between items-center gap-8 border-b border-white/5 pb-12 mb-12">
                <div>
                    ...
                    <p class="text-gray-500 text-xs md:text-sm mt-2 max-w-xs">Penyedia jasa rental kamera & camping equipment terpercaya.</p>
                </div>
                <div class="flex flex-wrap justify-center gap-6 md:gap-8 text-gray-400 text-[10px] font-bold uppercase tracking-widest">
