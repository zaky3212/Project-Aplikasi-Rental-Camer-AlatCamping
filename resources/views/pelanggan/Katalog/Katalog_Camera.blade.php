...
<head>
    ...
    <title>Katalog Camera - Lenscape</title>
...
<body class="bg-gray-50 font-sans overflow-x-hidden pt-24">
    ...
    <section class="relative h-[350px] md:h-[450px] overflow-hidden">
        <img src="https://images.unsplash.com/photo-1516035069371-29a1b244cc32?q=80&w=1638&auto=format&fit=crop" class="w-full h-full object-cover brightness-[0.4]" alt="Banner Kamera Lenscape">
        <div class="absolute inset-0 flex items-center px-6 md:px-20">
            <div class="text-white mt-8 md:mt-12 w-full max-w-2xl">
                ...
                <h1 class="text-3xl md:text-6xl lg:text-7xl font-extrabold leading-tight">Perlengkapan<br><span class="text-[#f3a933]">Kamera & Lensa</span></h1>
                <p class="mt-4 text-gray-300 text-xs md:text-base leading-relaxed line-clamp-3 md:line-clamp-none">Abadikan setiap momen berharga dengan kamera dan lensa bioskop terbaik. Performa profesional untuk hasil visual legendaris.</p>
            </div>
        </div>
    </section>
    ...
    <div class="max-w-7xl mx-auto px-4 md:px-6 py-12 md:py-20 space-y-16 md:space-y-24">
        ...
        <section>
            <div class="flex flex-col sm:flex-row justify-between items-start sm:items-end mb-8 md:mb-10 gap-4">
                ...
                <a href="{{ route('pelanggan.Katalog.Katalog_Camera.semua') }}" class="text-gray-400 hover:text-[#f3a933] transition text-sm font-semibold flex items-center gap-2">
            ...
            <div class="grid grid-cols-1 xs:grid-cols-2 lg:grid-cols-4 xl:grid-cols-5 gap-4 md:gap-8">
                ...
                <div class="bg-white rounded-[1.5rem] md:rounded-[2rem] shadow-sm hover:shadow-xl transition-all duration-500 border border-gray-100 overflow-hidden group relative flex flex-col">
                    ...
                    <a href="{{ route('pelanggan.Katalog.detail_barang', $item->id) }}" class="block flex-grow flex flex-col">
                        ...
                        <div class="p-4 md:p-6 flex-grow flex flex-col justify-between">
                            <div>
                                ...
                                <h3 class="font-bold text-gray-800 text-sm md:text-base truncate group-hover:text-[#f3a933] transition-colors" title="{{ $item->nama }}">
                                    {{ $item->nama }}
                                </h3>
                            </div>
                        </div>
                    ...
                    <div class="px-4 pb-4 md:px-6 md:pb-6">
                        <div class="pt-4 md:pt-5 border-t border-gray-50">
