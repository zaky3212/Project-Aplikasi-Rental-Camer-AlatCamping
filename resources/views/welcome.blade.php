...
<body class="bg-white text-gray-800 antialiased relative">
    ...
    <header
        class="sticky top-0 z-50 w-full bg-white/80 backdrop-blur-md shadow-sm border-b border-gray-100 transition-all duration-300 relative">
    ...
    <section id="beranda"
        class="container mx-auto px-6 pt-10 pb-20 flex flex-col-reverse md:flex-row items-center gap-12 relative z-10">

        <div class="w-full md:w-1/2 flex flex-col items-start">
            <p class="text-[#f3a933] font-bold text-sm tracking-widest uppercase mb-4">Gaya Terbaik Untuk Petualanganmu
            </p>
        ...
        <div class="w-full md:w-1/2 relative flex justify-center">
            <div
                class="absolute top-10 right-10 w-[350px] h-[350px] md:w-[450px] md:h-[450px] bg-[#fce8d5] blob-bg -z-10">
            </div>
    ...
    <section class="container mx-auto px-6 py-20 relative">
        ...
        <div class="absolute top-10 right-10 text-[#fff1da] text-6xl -z-10 font-sans tracking-widest leading-none">
            ++++<br>++++<br>++++</div>

        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div
                class="bg-white p-8 rounded-[30px] text-center transition hover:shadow-[0_20px_50px_rgba(0,0,0,0.08)] group">
                <div
                    class="w-20 h-20 mx-auto mb-6 flex items-center justify-center bg-blue-50 rounded-2xl group-hover:bg-[#f3a933] transition duration-300">
            ...
            <div class="bg-white p-8 rounded-[30px] text-center shadow-[0_20px_50px_rgba(0,0,0,0.08)] relative group">
                <div
                    class="absolute -bottom-6 -left-6 w-24 h-24 bg-[#f3a933] rounded-tl-[30px] rounded-br-[30px] -z-10">
                </div>
                <div
                    class="w-20 h-20 mx-auto mb-6 flex items-center justify-center bg-blue-50 rounded-2xl group-hover:bg-[#f3a933] transition duration-300">
    ...
    <section id="kamera" class="container mx-auto px-6 py-16">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 mb-10">
            @foreach ($kameraPilihan as $kamera)
                <div
                    class="bg-white border border-gray-100 rounded-2xl p-4 transition duration-300 hover:shadow-xl relative group">

                    <div
                        class="relative h-[200px] bg-gray-50 rounded-xl mb-4 overflow-hidden flex items-center justify-center">

                        <img src="{{ asset($kamera->gambar) }}" alt="{{ $kamera->nama }}"
                            class="object-cover h-full w-full group-hover:scale-110 transition duration-500">

                    </div>

                    <h4 class="font-bold text-[#181e4b] text-base truncate pr-2">
                        {{ $kamera->nama }}
                    </h4>

                    <div class="flex justify-between items-center mt-3">

                        <p class="text-[#f3a933] font-bold">
                            Rp {{ number_format($kamera->harga_sewa, 0, ',', '.') }}
                            <span class="text-xs text-gray-400 font-normal">/hari</span>
                        </p>

                        <a href="{{ route('login') }}"
                            class="w-8 h-8 rounded-full bg-blue-50 text-blue-900 flex items-center justify-center hover:bg-[#f3a933] hover:text-white transition">
            ...
            @foreach ($campingFavorit as $camping)
                <div class="bg-white border border-gray-100 rounded-2xl p-4 hover:shadow-xl transition relative group">
                    ...
                    <div class="flex justify-between items-center mt-3">
                        ...
                        <p class="text-[#f3a933] font-bold">
                            Rp {{ number_format($camping->harga_sewa, 0, ',', '.') }}
                            <span class="text-xs text-gray-400 font-normal">/hari</span>
                        </p>
